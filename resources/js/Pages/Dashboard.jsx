            ...
            <div>
                ...
                <main className="p-6 sm:p-10 space-y-6">
                    ...
                    <div className="flex items-center p-8 bg-white shadow rounded-lg">
                        ...
                        <div>
                        <span className="block text-2xl font-bold">147</span>
                    ...
                    <div className="flex items-center p-8 bg-white shadow rounded-lg">
                        ...
                        <span className="block text-gray-500">Number of Online Members</span>
                        </div>
                    </div>
                    <div className="flex items-center p-8 bg-white shadow rounded-lg">
                        ...
                        <div>
                        <span className="inline-block text-2xl font-bold">124 M</span>
                        <span className="block text-gray-500">Beneficiaries to Date</span>
                        </div>
                    </div>
                    <div className="flex items-center p-8 bg-white shadow rounded-lg">
                        ...
                        <span className="block text-gray-500">Number of Ongoing Projects</span>
                        </div>
                    </div>
                    </section>
